...
<title>Cultivate Pro - My Booking</title>
<!--Bootstrap -->
...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <button onclick="window.location.href = 'payment.html';" style="padding: 2px 10px; background-color: #007bff; color: #fff; border: none; border-radius: 5px; cursor: pointer;">Go to Payment Page</button>
...
<table>
  ...
  <tr>
    ...
    <th><?php echo htmlentities($tds*$ppd);?></th>
          ...
          NOTE : Payment button will appear after confirmation you can check it in MyBooking  section in profile
  <!--<button onclick="window.location.href = 'payment.html';" style="padding: 10px 20px; background-color: #007bff; color: #fff; border: none; border-radius: 5px; cursor: pointer;">Go to Payment Page</button>  -->
