...
echo "<script>alert('Something went wrong. Please try again');</script>";
 ...
 echo "<script>alert('Machines  already booked for these days');</script>"; 
 echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
}
...
<title>Cultivate Pro | Machine Details</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <label>To Date:</label>
              <input type="date" class="form-control" name="todate" placeholder="To Date" min="<?php echo date('Y-m-d'); ?>" required>
            </div>
            <div class="form-group">
